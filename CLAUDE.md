...
failed/reduced instruments go in `config/instrument_status.csv`. Both are hand-maintained and
persist across refreshes. (Per-run outputs go to `reports/<date>/`; investigation notes in `docs/`.)
